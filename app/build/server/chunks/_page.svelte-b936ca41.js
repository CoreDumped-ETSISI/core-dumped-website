import { c as create_ssr_component, v as validate_component, g as add_attribute, e as escape, f as each } from './ssr-27bb2042.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Title, "Title").$$render($$result, {}, {}, {
    ...
    $$result,
    {
      ...
      date: formData.date !== void 0 && formData.date.length > 0 ? formData.date : ( new Date()).toISOString(),
...
//# sourceMappingURL=_page.svelte-b936ca41.js.map
